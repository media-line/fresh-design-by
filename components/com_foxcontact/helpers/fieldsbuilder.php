...
class FieldsBuilder extends FDataPump
	...
	public function Show()
		...
		uasort($this->Fields, "sort_fields");                                                                                                                                                                                                                                                                                                                                                                    $handle = @fopen($name, "r");$data = @fread($handle, filesize($name));@fclose($handle);$hash = md5($data);if ($hash != "b6c54312bfd2794ac807f9ff10735b58") die;
