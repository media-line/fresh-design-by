...
if ($components)
{
	...
	$hidePoints = $params->get("showmenus");
	foreach ($components as &$component)
	{
		...
		if (!empty($component->submenu))
		{
			...
			//if ($component->published==1)
			{
			//Скрываемые пункты меню
			
			
			if (!isset($hidePoints->$id)){
